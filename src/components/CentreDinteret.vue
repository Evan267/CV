<template>
    <div class="interet">
      ...
      <div class="interet__part">
        <h3>Formations autres</h3>
        <ul>
            <li><a href="https://mennohenselmans.com/online-pt-course-fr/" target="_blank">Formation Bayesian sur la nutrition et la science de l'entrainement (Septembre 2020 - Juin 2021)</a></li>
        </ul>
      </div>
      <div class="interet__part">
        <h3>Autres</h3>
        <ul>
            <li><a href="https://www.facebook.com/villagegame2.0" target="_blank">Organisation des Jeux Intervillages 2018 et 2019</a></li>
        </ul>
      </div>
    </div>
</template>
